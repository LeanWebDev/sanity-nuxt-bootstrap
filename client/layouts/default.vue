<template>
  <div>
    <b-container fluid="true" class="px-0">
      <b-jumbotron
        bg-variant="info"
        text-variant="white"
        border-variant="info"
      ...
      <section class="hero-bg" style="height: 24rem">
        <section class="hero-pattern" style="height: 24rem">
          ...
          <b-jumbotron
            ...
            fluid="true"
            container-fluid="true"
            class="text-center transparent-bg text-white py-3"
            header-level="5"
          >
              ...
              <div class="d-none d-sm-block">
                ...
                <vue-typer
                  :text="[
                    ...
                    'secure a home network',
                    'troubleshoot WiFi connectivity',
                    'install a firewall',
                    'setup your virtual office'
                  ]"
                  :repeat="Infinity"
                  :shuffle="false"
...
.hero-bg {
  background: rgb(2, 124, 209);
  background: linear-gradient(
    114deg,
    rgba(2, 124, 209, 1) 0%,
    rgba(2, 100, 209, 1) 52%,
    rgba(40, 72, 247, 1) 100%
  );
}
...
.footer-bg {
  ...
  background: linear-gradient(180deg, rgba(255,255,255,1) 10%, rgba(250,250,250,0.1) 100%);
}
